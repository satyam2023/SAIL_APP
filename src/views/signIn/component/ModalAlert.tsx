...
const ModalAlert:React.FC<ModalAlertProps> = ({visibilityStatus,SetModalScreen}:ModalAlertProps) => {
  ...
  return (
    ...
    >
      ...
      <Image source={Glyphs.Profile2userClicked} style={{height:50,width:50,alignSelf:'center',marginLeft:75}}/>
   <TouchableOpacity onPress={()=>{SetModalScreen(false)}}>
    <Image source={Glyphs.Close} style={{marginLeft:40,marginTop:20}}/>
